...
本分支共 **23 个搜索源、覆盖 18 个目录服务**（上游基线 21 源 / 16 服务 + 本分支新增的 Bangumi 与 NeoDB）。**"国内直连"一列仅标注本分支实测过的结论**，未评估的留空 —— 上游源的海外可达性随网络环境而异，本仓库不做保证。
...
| 图书 | [NeoDB](https://neodb.social/) | 免密钥 | **✅ 已实测** |
